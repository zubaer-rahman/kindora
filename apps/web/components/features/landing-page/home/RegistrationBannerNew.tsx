      ...
      <div className="container max-w-[1170px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-[40px] font-semibold text-foreground leading-tight md:leading-[48px]">
              KINDORA 2025 registration has just opened!
            </h2>
            <p className="text-base md:text-lg text-muted-foreground py-6 md:py-8">
            ...
            <Button className="bg-primary cursor-pointer rounded-full h-[49px] hover:bg-primary/90 text-primary-foreground px-[30px] py-[15px] text-base md:text-lg w-full sm:w-auto">
              Join now
            </Button>
          </div>
