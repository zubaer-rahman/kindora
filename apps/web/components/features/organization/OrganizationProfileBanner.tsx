    ...
    return (
        <div className="relative w-full rounded-[24px] overflow-hidden shadow-sm mb-8 min-h-[140px] md:min-h-[160px]">
            ...
            <div className="absolute top-4 right-4 md:top-6 md:right-6 z-30 flex justify-end items-center">
                ...
                <Badge
                    variant="secondary"
                    className="bg-muted/90 backdrop-blur-md text-foreground hover:bg-muted px-4 py-1.5 rounded-full text-sm font-medium border-none whitespace-nowrap shadow-sm"
                >
                    ...
                    <div className="space-y-1.5 sm:space-y-1">
                        ...
                        {organizationProfile?.website && (
                            <Link
                                ...
                                className="flex items-center text-muted-foreground hover:text-primary transition-colors gap-2"
                            >
                                <ExternalLink className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 text-muted-foreground" />
