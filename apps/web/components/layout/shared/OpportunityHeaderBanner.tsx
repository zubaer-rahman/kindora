    ...
    return (
        <div className="relative w-full rounded-[24px] overflow-hidden shadow-sm mb-8 min-h-[140px] md:min-h-[160px]">
            ...
            <div className="absolute top-4 right-4 md:top-6 md:right-6 z-30 flex justify-end items-center">
                <Badge
                    variant="secondary"
                    className="bg-background/90 backdrop-blur-md text-foreground hover:bg-background px-4 py-1.5 rounded-full text-sm font-medium border-border whitespace-nowrap shadow-sm"
                >
            ...
            <div className="relative z-10 p-5 pt-14 sm:p-6 sm:pt-14 md:p-8 md:pt-10 flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10 h-full">
                ...
                <div className="flex-shrink-0 w-15 h-15 sm:w-19 sm:h-19 md:w-23 md:h-23 rounded-[16px] sm:rounded-[18px] overflow-hidden shadow-sm bg-card p-1">
                ...
                <div className="flex-1 flex flex-col justify-center min-w-0">
                    <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground mb-1 sm:mb-2 break-words drop-shadow-md">
                        {opportunity?.title}
                    </h1>
                    <p className="text-muted-foreground text-xs sm:text-sm md:text-base font-medium drop-shadow-md">
                ...
                {userRole === "organisation" && isCurrentUserFromOpportunityOrg && (
                    <div className="flex-shrink-0 md:ml-auto w-full md:w-auto mt-6 md:mt-0 flex items-center gap-3">
                        <Button
                            ...
                            className="bg-background hover:bg-muted text-primary px-5 py-2 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold shadow-sm border border-border transition-all duration-200"
                        >
